...
public class Human extends GameCharacters {
    public Human(String name, double hp, int loadCapacity, Weapons weapons, int initiative, Armor armor, double maxHP, int coins, double damage, int defens) {
        super(name, hp, loadCapacity, weapons, initiative, armor, maxHP, coins, damage, defens);
    }

    public double humanDamage(Weapons weapons) {
