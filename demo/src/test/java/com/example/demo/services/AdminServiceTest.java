...
class AdminServiceTest{
    ...
    void createNewSubject() throws Exception {
        ...
        verify(adminRepository,times(1)).createNewSubject(Mockito.any());
    }
    @DirtiesContext
    @Transactional
    @Test
    void editSubject() throws Exception {
        ...
        verify(adminRepository,times(1)).editSubject(Mockito.anyInt(), Mockito.any());
    }
    @DirtiesContext
    @Transactional
    @Test
    public void deleteSubject() throws Exception {
        ...
        verify(adminRepository,times(1)).deleteSubject(Mockito.anyInt());
    }
